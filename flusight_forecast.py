...
def apply_forecast_exceptions(
    ...
    if fop.state_name == "California":
        ...
        fop.sp["drift_coef"] *= 1.0 / 1.25
        fop.ep["scale_ref_inc"] *= 1.25
        pass
