...
class FluSight2025ForecastOperator(ForecastOperator):
    """
    This is the forecast operator for the 2025-2026 season of the CDC
    FluSight forecast.
    ...
    is_aggr = True  # Refers to the INPUT DATA: it's aggregated (weekly)
